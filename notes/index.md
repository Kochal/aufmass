...
## ui
| Date | File | Summary |
| 2026-07-01 | [workflow-ux-improvements](ui/2026-07-01-workflow-ux-improvements.md) | Nav reorder; inline Ag/Proj creation; Auftraggeber create-and-navigate; Neue Rechnung filter; match_status fix; sort/search on all four list tables; Auftraggeber+Projekt columns in AngebotList |
